...
const ImgSelectButton = ({ btnText, desText, media, productCover }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className="normalButton-line" onClick={onOpenHandler}>
        {btnText}
      </div>
      {open && (
              ...
              <div className="modalHight">
                <div className={`flexBox ${styles.innerBox}`}>
                  {media?.length ? (
                    ...
                    <>
                      <p className="text-gray">目前沒有任何媒體...</p>
                      <Link
                        href="/media/uploadImg"
                        className="normalButton-line"
                      >
                        前往上傳
                      </Link>
                    </>
